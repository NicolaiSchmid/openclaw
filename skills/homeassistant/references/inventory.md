...
## Hallway (3)
### light (1)
- `light.doorman_s3_status_led` — Doorman S3 Status LED = **off**
...
### media_player (2)
- `media_player.fire_tv_10_0_0_80` = **unavailable**
- `media_player.tx_nr609` — Onkyo = **unavailable**
...
- `switch.hp508140d79d5a_internet_access` — HP508140D79D5A Internet Access = **unavailable**
- `switch.ipad_internet_access` — iPad-2 Internet Access = **unavailable**
- `switch.ipad_internet_access_2` — iPad Internet Access = **unavailable**
- `switch.ipad_internet_access_3` — iPad Internet Access = **unavailable**
...
- `switch.iphone_internet_access_5` — iPhone Internet Access = **unavailable**
- `switch.iphone_von_andreas_internet_access` — iPhone-von-Andreas Internet Access = **unavailable**
- `switch.iphone_von_monika_2_internet_access` — iPhone-von-Monika-2 Internet Access = **unavailable**
- `switch.iphone_von_monika_internet_access` — iPhone-von-Monika Internet Access = **unavailable**
...
- `switch.macbookpro_internet_access_2` — MacBookPro Internet Access = **unavailable**
- `switch.macbookpro_internet_access_3` — MacBookPro Internet Access = **unavailable**
- `switch.mansis_iphone_2_internet_access` — mansis-iPhone-2 Internet Access = **unavailable**
- `switch.mansis_iphone_internet_access` — mansis-iPhone Internet Access = **unavailable**
- `switch.mbp_von_nicolai_internet_access` — MBP-von-Nicolai Internet Access = **unavailable**
- `switch.nicolais_macbook_pro_internet_access` — Mac Internet Access = **unavailable**
- `switch.oneplus_7_internet_access` — OnePlus-7 Internet Access = **unavailable**
- `switch.pc_10_0_0_101_internet_access` — PC-10-0-0-101 Internet Access = **unavailable**
- `switch.pc_10_0_0_21_internet_access` — PC-10-0-0-21 Internet Access = **unavailable**
- `switch.pc_10_0_0_55_internet_access` — 8748bb91-ee35-4796-8fee-1fbf54bebab8 Internet Access = **unavailable**
- `switch.pc_10_0_0_56_internet_access` — PC-10-0-0-56 Internet Access = **unavailable**
- `switch.pc_10_0_0_64_internet_access` — 01c1d95c-f02e-408c-8d8b-cb90f17e4929 Internet Access = **unavailable**
- `switch.pc_10_0_0_68_internet_access` — 85e36f77-ea8d-4e87-b9d6-f29b3fedb092 Internet Access = **unavailable**
- `switch.pc_10_0_0_86_internet_access` — PC-10-0-0-86 Internet Access = **unavailable**
- `switch.pc_10_0_0_93_internet_access` — PC-10-0-0-93 Internet Access = **unavailable**
- `switch.pc_10_0_0_98_internet_access` — PC-10-0-0-98 Internet Access = **unavailable**
- `switch.pc_1c99_bcf8_3451_ef4b_internet_access` — PC---1c99-bcf8-3451-ef4b Internet Access = **unavailable**
- `switch.pc_4b1_53e0_e746_7f5e_internet_access` — mansis-iPhone Internet Access = **unavailable**
- `switch.pc_5e_56_3a_82_31_20_internet_access` — PC-10-0-0-65 Internet Access = **unavailable**
...
- `switch.tx_nr609_internet_access` — TX-NR609 Internet Access = **unavailable**
- `switch.unused` — unused = **off**
- `switch.unused_1` — unused 1 = **off**
- `switch.unused_child_lock` — unused Child lock = **off**
- `switch.wohnzimmer_fan_unassigned` — [Wohnzimmer] Fan_unassigned = **off**
...
- `switch.wohnzimmer_stehlampe_child_lock` — [Wohnzimmer] Stehlampe Child lock = **off**
- `switch.xx_unused` — xx unused = **off**
...
### scene (2)
- `scene.offffff` — Offffff = **2025-01-18T19:11:41.769802+00:00**
- `scene.shleeep` — Shleeep = **2025-05-02T22:50:45.370976+00:00**

### script (1)
- `script.schlafzimmer_switch_on_fan` — [Schlafzimmer] Fan = **off**

### automation (20)
- `automation.55_turn_off_humidifyer` — [Bedroom] > 80 humidity switch off humidifyer = **on**
- `automation.bathroom_motion_light` — [bathroom] motion light = **on**
- `automation.firetv_turn_audio_when_playing` — [FireTV] Turn Audio When Playing = **off**
- `automation.handy` — Handy = **on**
- `automation.humidify_bedroom` — [Bedroom] < 78 humidity switch on humidifyer = **on**
- `automation.kuche_motion_light_off` — [Küche] Motion Light – Off = **on**
- `automation.kuche_motion_light_on` — [Küche] Motion Light – On = **on**
- `automation.lichterkette_an` — [Balkon] Lichterkette An = **on**
- `automation.lichterkette_aus` — [Balkon] Lichterkette Aus = **on**
- `automation.lichterkette_morgen_an` — [Balkon] Lichterkette - Morgen an = **on**
- `automation.lichterkette_nachts_ausschalten` — [Balkon] Lichterkette - nachts ausschalten = **on**
- `automation.light_greeting` — Light Greeting = **on**
- `automation.schlafzimmer_fan_timed_off` — [Schlafzimmer:Fan] Timed-Off = **off**
- `automation.schlafzimmer_fan_turn_off_with_timer` — [Schlafzimmer:Fan] Turn Off With Timer = **off**
- `automation.schlafzimmer_heizen` — Schlafzimmer nachts heizen = **off**
- `automation.schlafzimmer_licht_lichterkette` — [Schlafzimmer] Licht<>Lichterkette = **on**
- `automation.schlafzimmer_taster_hold` — [Schlafzimmer] Taster Hold = **on**
- `automation.stupid` — Stupid = **off**
- `automation.wohnzimmer_taster` — [Schlafzimmer] Taster = **on**
- `automation.wohzimmer_morgens_heizen` — Wohnzimmer morgens heizen = **off**

### input_boolean (1)
- `input_boolean.enabled_kitchen_motion_senser` — [enabled] kitchen motion senser = **off**
